...
* Next, download the Data Cube setup files and code from the above repository and unzip into a local folder of your choice. Navigate to the path to your folder in PowerShell using the cd command e.g. 'cd C:/cubeinabox/'.
...
You will need AWS access keys, please set them as environment variables as described above.
